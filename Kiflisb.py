...
kifli = LineClient()
kifli.log("Auth Token : EOi1Rf8gUJogYizzgRm7.dTLx2I25fu/VupAK1OVmfW.VGBPoAEx3jmhldiNwdwBZBcMa1Cbk+wWZC5ZKiA7t7g=" + str(kifli.authToken))
channel = LineChannel(kifli)
kifli.log("Channel Access Token : " + str(channel.channelAccessToken))
print("\nBOT MULAI BERJALAN.......\n")

poll = LinePoll(kifli)
call = kifli
creator = ["u0ed957da2db9154faf50f6a4d68bcc17"]
owner = ["u0ed957da2db9154faf50f6a4d68bcc17"]
admin = ["u0ed957da2db9154faf50f6a4d68bcc17"]
staff = ["u0ed957da2db9154faf50f6a4d68bcc17"]
