...
channel1 = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='Ezizf2qItPhYHH2wGBQd.dTbkez9byvQdGSoZqBLYdq.7u1WQ6E0UI6F0A2cw1KFSg2w+cv7rlwg5RUQzjp4mbM=')
ki.log("Auth Token : " + str(ki.authToken))
channel2 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel2.channelAccessToken))

kk = LineClient(authToken='Ezizf2qItPhYHH2wGBQd.dTbkez9byvQdGSoZqBLYdq.7u1WQ6E0UI6F0A2cw1KFSg2w+cv7rlwg5RUQzjp4mbM=')
