...
#cl = LineClient()
cl = LineClient(authToken="EOrpYL5h9q3l5H7QeVa2.elcsFyZUWbpi+wyJdTA5GG.24zS85EGcBA4hmM5yNucoX3mThTIIuQhSg0Ogyw4f8k=")
...
ki = LineClient(authToken="EOrNIePPTy5rCWuB9Uo1.sVNUBVx/BnvaQLNekAGJWq.B8J9Gm5ZZ4Yz5MJgOCuwHrtw9DJGo4SS/gdlckiMdbc=")
channel2 = LineChannel(ki,ki.server.CHANNEL_ID['LINE_TIMELINE'])
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Channel Access Token : " + str(channel2.channelAccessToken))

kk = LineClient(authToken="EOARkwELAA76Q4QdCmE3.KUbtxXOPObCvpZ3urACrqW.Nmiom76KXXpJy0btU1JXjpbuFIz3PhlZwiQlzMlFuII=")
channel3 = LineChannel(kk,kk.server.CHANNEL_ID['LINE_TIMELINE'])
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Channel Access Token : " + str(channel3.channelAccessToken))

kc = LineClient(authToken="EOeHStvFSPBlhqAMhDZf.ZIa+sNh4dPDEscIJw2NXpW.fq9sAFhB++qvW+bBk5C4b60MtA+tUFL3/MmYgwjzB+o=")
channel4 = LineChannel(kc,kc.server.CHANNEL_ID['LINE_TIMELINE'])
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Channel Access Token : " + str(channel4.channelAccessToken))

kb = LineClient(authToken="EOVBZqpuiBzUn0SqKGEa.4epB2weA7OFFgPvok2b7wG.lqFSzu3tHX2yq/ckLKcDmi7tVlFlxWKOSaVJ5zoiySg=")
channel5 = LineChannel(kb,kb.server.CHANNEL_ID['LINE_TIMELINE'])
kb.log("Auth Token : " + str(kb.authToken))
kb.log("Channel Access Token : " + str(channel5.channelAccessToken))

kd = LineClient(authToken="EOVxm8uxJrFvQIPLMxge.81QbcWHXRQfEcPeVw+dqZG.mLmz0M0mYb01txTTjwBejbSybccoYWXHx+EE4MezTKo=")
channel6 = LineChannel(kd,kd.server.CHANNEL_ID['LINE_TIMELINE'])
kd.log("Auth Token : " + str(kd.authToken))
kd.log("Channel Access Token : " + str(channel6.channelAccessToken))

ke = LineClient(authToken="EOw5kdOJMDJcpaueY13c.fBcz5CA5laduO/S1h6tCBa.XPiUUfweD/ZBnozdyw06X3MBS9pvlEJYkl+p1OlvKGI=")
channel7 = LineChannel(ke,ke.server.CHANNEL_ID['LINE_TIMELINE'])
ke.log("Auth Token : " + str(ke.authToken))
ke.log("Channel Access Token : " + str(channel7.channelAccessToken))

kf = LineClient(authToken="EO5YWZySIbkUQ3WYMzhd.fgbmkJS3o1OXlSjTLEG9dq.Efb2J/xr1cHdYoTWl3+9bKXgcJyeLOEFjIoFgYMVjo8=")
channel8 = LineChannel(kf,kf.server.CHANNEL_ID['LINE_TIMELINE'])
kf.log("Auth Token : " + str(kf.authToken))
kf.log("Channel Access Token : " + str(channel8.channelAccessToken))

kg = LineClient(authToken="EOOkJorDOo6CyQUZNu98.Ym/vvbfiKaNSIyppFAC86a.aTc6KX1uNHGeq5nxgRqIGLt6lmEMd66EOhlBYu+sWNk=")
channel9 = LineChannel(kg,kg.server.CHANNEL_ID['LINE_TIMELINE'])
kg.log("Auth Token : " + str(kg.authToken))
kg.log("Channel Access Token : " + str(channel9.channelAccessToken))

sw = LineClient(authToken="EOyu6EYMPOzDzfGuGvYc.QWHUuCFbquVN/uM2GNJila.4vlbKyoga3kh9Y0Z0UcjDa6ei4ulQfkgzNuRXQ4OQiI=")
channel10 = LineChannel(sw,sw.server.CHANNEL_ID['LINE_TIMELINE'])
sw.log("Auth Token : " + str(sw.authToken))
sw.log("Channel Access Token : " + str(channel10.channelAccessToken))

js = LineClient(authToken="EOaZQEH3LWLLu3EBPCGb.JiEIhjVYk9WvBBA/yM1HoW.LAbchH3OpB6s0Rlyv9uu/JBNc5dzg3pbaYLM3srtWSM=")
channel11 = LineChannel(js,js.server.CHANNEL_ID['LINE_TIMELINE'])
js.log("Auth Token : " + str(js.authToken))
js.log("Channel Access Token : " + str(channel11.channelAccessToken))

sx = LineClient(authToken="EOf01Q22paY7fv5UC2s4.PYalYPaPECfqPK9XPYfYTa.zktYDnrNEU3VmpD+uH+01hrShnQ0ZOxHaID9wm4/U0g=")
channel12 = LineChannel(sx,sx.server.CHANNEL_ID['LINE_TIMELINE'])
...
poll = LinePoll(cl)
call = cl
creator = ["ufc996eebf5fa7a110cd5061e83016d04"]
owner = ["ufc996eebf5fa7a110cd5061e83016d04"]
admin = ["ufc996eebf5fa7a110cd5061e83016d04"]
staff = ["ufc996eebf5fa7a110cd5061e83016d04"]
...
Jmid = js.getProfile().mid
Xmid = sx.getProfile().mid
KAC = [cl,ki,kk,kc,kb,kd,ke,kf,kg,sw]
ABC = [ki,kk,kc,kb,kd,ke,kf,kg,sw]
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Zmid,Jmid,Xmid]
KICKER = [sw,js,sx]
Saints = admin + staff
...
def help():
    ...
    key = key.title()
    helpMessage = "🔑❂͜͡➣ " + key + " [TRIBOTSLINE]\n" + \
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "🔑❂͜͡➣ " + key + " [TRIBOTSLINE]\n" + \
                  "🔑❂͜͡➣ " + key + "ᴛᴀɢᴀʟʟ/ɴᴀʜ\n" + \
                  "🔑❂͜͡➣ " + key + "ɢɪɴғᴏ\n" + \
                  "🔑❂͜͡➣ " + key + "ᴏᴘᴇɴ\n" + \
                  "🔑❂͜͡➣ " + key + "ᴄʟᴏsᴇ\n" + \
                  ...
                  "🔑❂͜͡➣ " + key + "sᴘᴀᴍᴄᴀʟʟ:「ᴊᴜᴍʟᴀʜɴʏᴀ」\n" + \
                   ...
                   "「🔑]   TRIBOTSLINE「🔑] \n" + \
                   "  Creator:  line.me/ti/p/~zherolove"
        ...
        if op.type == 13:
            if Dmid in op.param3:
                ...
                for taged in InviterX:
                    if taged in bl['blacklist']:
                        try:
                            kb.cancelGroupInvitation(op.param1,[taged])
        ...
        if op.type == 13:
            if Emid in op.param3:
                ...
                for taged in InviterX:
                    if taged in bl['blacklist']:
                        try:
                            kd.cancelGroupInvitation(op.param1,[taged])
        ...
        if op.type == 13:
            if Fmid in op.param3:
                ...
                for taged in InviterX:
                    if taged in bl['blacklist']:
                        try:
                            ke.cancelGroupInvitation(op.param1,[taged])
        ...
        if op.type == 13:
            if Gmid in op.param3:
                ...
                for taged in InviterX:
                    if taged in bl['blacklist']:
                        try:
                            kf.cancelGroupInvitation(op.param1,[taged])
        ...
        if op.type == 13:
            if Hmid in op.param3:
                ...
                for taged in InviterX:
                    if taged in bl['blacklist']:
                        try:
                            kg.cancelGroupInvitation(op.param1,[taged])
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    inv2 = inv1.split(',')
                                    for target in inv2:
                                        kb.cancelGroupInvitation(op.param1, [target])
                                        kb.kickoutFromGroup(op.param1, [op.param2])
                                        bl["blacklist"][op.param2] = True
                                except:
                                    try:
                                        ...
                                        inv2 = inv1.split(',')
                                        for target in inv2:
                                            kd.cancelGroupInvitation(op.param1, [target])
                                            kd.kickoutFromGroup(op.param1, [op.param2])
                                            bl["blacklist"][op.param2] = True
                                    except:
                                        try:
                                            ...
                                            inv2 = inv1.split(',')
                                            for target in inv2:
                                                ke.cancelGroupInvitation(op.param1, [target])
                                                ke.kickoutFromGroup(op.param1, [op.param2])
                                                bl["blacklist"][op.param2] = True
                                        except:
                                            try:
                                                ...
                                                inv2 = inv1.split(',')
                                                for target in inv2:
                                                    kf.cancelGroupInvitation(op.param1, [target])
                                                    kf.kickoutFromGroup(op.param1, [op.param2])
                                                    bl["blacklist"][op.param2] = True    
                                            except:
                                                try:
                                                   ...
                                                   inv2 = inv1.split(',')
                                                   for target in inv2:
                                                       kg.cancelGroupInvitation(op.param1, [target])
                                                       kg.kickoutFromGroup(op.param1, [op.param2])
                                                       bl["blacklist"][op.param2] = True
                                                except:
                                                	pass       
            ...
            if wait["ghost"] == True:
                try:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        wait["blacklist"][op.param2] = True
                        sw.sendMessage(op.param1,"dont play brow")
                    ...
                    try:
                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                            ...
                            sx.kickoutFromGroup(op.param1,[op.param2])
                            wait["blacklist"][op.param2] = True
                            ki.sendMessage(op.param1,"dont play brow")
                            js.leaveGroup(op.param1)
                            sx.leaveGroup(op.param1)
                            X = ki.getGroup(op.param1)
                            X.preventedJoinByTicket = True
                        ...
                        try:
                            if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                ...
                                sx.kickoutFromGroup(op.param1,[op.param2])
                                wait["blacklist"][op.param2] = True
                                js.sendMessage(op.param1,"dont play brow")
                                js.leaveGroup(op.param1)
                                sx.leaveGroup(op.param1)
                                X = kk.getGroup(op.param1)
                                X.preventedJoinByTicket = True
            ...
            try:
                if op.param1 in protectantijs:
                  if op.param3 in mid:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        js.leaveGroup(op.param1)
                        sw.leaveGroup(op.param1)
                        sw.findAndAddContactsByMid(op.param1,[Jmid,Xmid])
                        sw.inviteIntoGroup(op.param1,[Jmid,Xmid])
                ...
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    if op.param3 in admin:
                        if op.param1 in protectantijs:
                            wait["blacklist"][op.param2] = True
                            sw.kickoutFromGroup(op.param1,[op.paramK2])
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            ke.nviteIntoGroup(op.param1,admin)
                                        except:
                                            try:
                                                kf.kickoutFromGroup(op.param1,[op.param2])
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     path10 = js.downloadObjectMsg(msg_id)
                     path11 = sx.downloadObjectMsg(msg_id)
                     ...
                     js.updateProfilePicture(path3)
                     js.sendMessage(msg.to, "Berhasil mengubah foto profile bot")
                     sx.updateProfilePicture(path3)
                     sx.sendMessage(msg.to, "Berhasil mengubah foto profile bot")
...
#===========BOT UPDATE============#
                        ...
                        elif cmd.startswith("ghostn2ame: "):
                          if msg._from in admin:
                            separate = msg.text.split(" ")
                            string = msg.text.replace(separate[0] + " ","")
                            if len(string) <= 10000000000:
...
#===========BOT UPDATE============#    
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    cl.sendMessage(msg.to,"Grup"+str(ginfo.name)+"dont play brow")
                                except:
                                    pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    sw.inviteIntoGroup(msg.to, [Jmid,Xmid])
                                    sw.sendMessage(msg.to,"Grup"+str(ginfo.name)+"Siaga Di luar ")
                                except:
                                    pass           
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ginfo = cl.getGroup(msg.to)
                                    cl.inviteIntoGroup(msg.to, [Zmid,Jmid,Xmid])
                        ...
                        elif "xxx89" in msg.text:
                           if msg._from in Bots:
                            if msg.toType == 2:
                             #  print "Otw cleanse"
                               _name = msg.text.replace("xxx89","")
...
"Ⓜⓐⓗ━👿━\n"
		...
		"╚╩╝╚╝╚╝━╚╝━╚╝╚╝\n"
		"━━━━━━━━━━━━━━━\n"
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~zherolove\nhttp://line.me/ti/p/~tribotline")
                               targets = []
                               for g in gs.members:
                                   if _name in g.displayName:
                                       targets.append(g.mid)
...
#===========ADMIN ADD============#
                          ...
                          if wait["selfbot"] == True:
                        ...
                        elif cmd == "pro on" or text.lower() == 'Allpro on':
                            if msg._from in owner or msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"protectqr Sudah On...")                                
                                cl.sendMessage(msg.to,"protectinvite Sudah On...")
                                cl.sendMessage(msg.to,"protectantijs Sudah On...")                               
                                cl.sendMessage(msg.to,"ghost Sudah On...")
                                
                        elif cmd == " pro off" or text.lower() == 'Allpro off':
                            if msg._from in owner or msg._from in admin:
                                wait["protectqr"] = False                                                               
                                wait["protectantijs"] = False
                                wait["ghost"] = False 
                                wait["proinvite"] = False 
                                cl.sendMessage(msg.to,"Loading...")
                                cl.sendMessage(msg.to,"protectqr Sudah Off...")                               
                                cl.sendMessage(msg.to,"protectantijs Sudah Off...") 
                                cl.sendMessage(msg.to,"protectinvite Sudah Off...") 
                                cl.sendMessage(msg.to,"ghost Sudah Off...")
