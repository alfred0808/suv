...
channel1 = LineChannel(kd,kd.server.CHANNEL_ID['LINE_TIMELINE'])
kd.log("Channel Access Token : " + str(channel1.channelAccessToken))
...
channel1 = LineChannel(js,js.server.CHANNEL_ID['LINE_TIMELINE'])
js.log("Channel Access Token : " + str(channel1.channelAccessToken))
...
KAC = [ki,kk,kc,kb,kd]
ABC = [ki,kk,kc,kb,kd]
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Zmid,Jmid]
Ghost = [sw,js]
Dpk = admin + staff
...
wait = {
    ...
    "unsend":True,
    "mention":"Nah Ngintip Udah ketahuan jg Masuk sini🤣🤣",
    "Respontag":"Ada yg ngetag pasti pengen ketularan Manis😋😋",
    "welcome":"CALON TIKUNGAN BARU MASUK WELLCOME YA KK",
    "leave":"KOK ADA YG MENINGGAL",    
                    ...
                    try:
                        if kk.getGroup(op.param1).preventedJoinByTicket == False:
                            if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                ...
                                js.acceptGroupInvitationByTicket(op.param1,Ti)
            ...
            if wait["ghost"] == True:
                try:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        cl.updateGroup(X)
                        X.preventedJoinByTicket = True
                        cl.inviteIntoGroup(op.param1,[Zmid,Jmid])
                        wait["blacklist"][op.param2] = True
                except:
                    pass
